            ...
            children: [
              ...
              Padding(
                ...
                child: RichText(
                  textAlign: TextAlign.center,
                  text: TextSpan(
                    style: kStyle(kRegular, kSize14, color: kWhite, height: 1.35),
                    children: const [
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: kStyle(kRegular, kSize12, color: kTextColor, height: 1.25),
                ),
              ],
            ),
          ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                title,
                style: kStyle(kSemiBold, kSize17, color: titleColor, height: 1.1),
              ),
              const SizedBox(height: 5),
              Text(
                subtitle,
                textAlign: TextAlign.center,
                style: kStyle(kRegular, kSize12, color: subtitleColor, height: 1.1),
              ),
            ],
          ),
        ),
